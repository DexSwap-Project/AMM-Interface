...
import { Currency, currencyEquals, Percent, CurrencyAmount, JSBI, ChainId, RoutablePlatform } from 'dexswap-sdk'
...
export default function RemoveLiquidity({
  ...
  const routerAddress = RoutablePlatform.DEXSWAP.routerAddress[chainId ? chainId : ChainId.MAINNET]
