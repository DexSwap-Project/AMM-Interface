...
export const DarkCard1 = styled(Card)<{ selectable?: boolean }>`
  position: relative;
  cursor: ${props => (props.selectable ? 'pointer' : 'auto')};
  z-index: 0;
  position: relative;
...
export const DarkCard2 = styled(Card)<{ selectable?: boolean }>`
  background-image: linear-gradient(180deg, rgba(41, 38, 67, 0) 0%, rgba(68, 65, 99, 0.5) 100%);
  position: relative;
  cursor: ${props => (props.selectable ? 'pointer' : 'auto')};
  z-index: 0;
...
`
export const DarkCard3 = styled(Card)<{ selectable?: boolean }>`
  position: relative;
  cursor: ${props => (props.selectable ? 'pointer' : 'auto')};
  z-index: 0;
  position: relative;
...
export const DarkCard4 = styled(Card)<{ selectable?: boolean }>`
  background-image: linear-gradient(180deg, rgba(41, 38, 67, 0) 0%, rgba(68, 65, 99, 0.5) 100%);
  position: relative;
  cursor: ${props => (props.selectable ? 'pointer' : 'auto')};
  z-index: 0;
